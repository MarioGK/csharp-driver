...
namespace Cassandra.Tests.DataStax.Cloud
{
    ...
    public class CustomCaCertificateValidatorTests
    {
        ...
        public void TestCertificateWithoutWildcardAndWithRootCaInChain()
        {
            ...
            var ca = X509CertificateLoader.LoadCertificate(Convert.FromBase64String(rootcab64));
            var cert = X509CertificateLoader.LoadCertificate(Convert.FromBase64String(certb64));
        ...
        public void TestCertificateWithWildcardAndNoRootCaInChain()
        {
            ...
            var ca = X509CertificateLoader.LoadCertificate(Convert.FromBase64String(rawDataCa));
            var cert = X509CertificateLoader.LoadCertificate(Convert.FromBase64String(rawData));
            var chain = new X509Chain();
            chain.ChainPolicy.RevocationMode = X509RevocationMode.NoCheck;
            chain.Build(cert);
        ...
        public void TestCertificateWithCustomDomainInSan_WithNormalDomain()
        {
            ...
            var cert = X509CertificateLoader.LoadCertificate(Convert.FromBase64String(customDomainRawData));
            var chain = new X509Chain();
            chain.ChainPolicy.RevocationMode = X509RevocationMode.NoCheck;
            chain.Build(cert);
